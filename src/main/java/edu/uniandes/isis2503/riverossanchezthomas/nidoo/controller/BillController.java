...
public class BillController {
	...
	@ResponseBody
	public Bill getBillID(@PathVariable("id") String id) {
		try {
	...
	@ResponseBody
	public String createBillRefund(@PathVariable("id") String id, @RequestBody @Valid Refund refund) {
		try {
			Bill bill = billDAO.findBillById(id);
			if (bill == null) {
	...
	@ResponseBody
	public List<Refund> findBillRefund(@PathVariable("id") String id) {
		try {
			Bill bill = billDAO.findBillById(id);
			if (bill == null) {
				throw new Exception("The bill  with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public Refund updateBillRefund(@PathVariable("id") String id, @RequestBody @Valid Refund refund) {
		try {
			Bill bill = billDAO.findBillById(id);
			if (bill == null) {
				throw new Exception("The bill  with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public String deleteBillRefund(@PathVariable("id") String id, @PathVariable("idR") long idR) {
		try {
			Bill bill = billDAO.findBillById(id);
			if (bill == null) {
				throw new Exception("The bill  with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public Booking findBillBooking(@PathVariable("idP") String idP) {
		try {
