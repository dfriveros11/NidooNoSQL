...
public class GuardController {
	...
	@ResponseBody
	public Guard getGuard(@PathVariable("id") String id) {
		try {
			Guard guard = guardDAO.findGuardById(id);
			if (guard == null) {
	...
	@ResponseBody
	public String deleteGuard(@PathVariable("id") String id) {
		try {
			Guard guard = guardDAO.findGuardById(id);
			if (guard == null) {
				throw new Exception("The guard identified with id: " + id + " doesn´t exits");
	...
	@ResponseBody
	public Parking findParkingGuards(@PathVariable("id") String id) {
		try {
			Guard guard = guardDAO.findGuardById(id);
			if (guard == null) {
				throw new Exception("The guard identified with id: " + id + " doesn´t exits");
	...
	@ResponseBody
	public String createBookingGuard(@PathVariable("id") String id, @RequestBody @Valid Booking booking) {
		try {
			Guard guard = guardDAO.findGuardById(id);
			if (guard == null) {
	...
	@ResponseBody
	public Booking findByIDGuardBooking(@PathVariable("id") String id, @PathVariable("idB") String idB) {
		try {
			Guard guard = guardDAO.findGuardById(id);
			if (guard == null) {
				throw new Exception("The guard with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public List<Booking> findGuardBooking(@PathVariable("id") String id) {
		try {
			Guard guard = guardDAO.findGuardById(id);
			if (guard == null) {
				throw new Exception("The guard with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public Booking updateGuardBooking(@PathVariable("id") String id, @RequestBody @Valid Booking booking) {
		try {
			Guard guard = guardDAO.findGuardById(id);
			if (guard == null) {
				throw new Exception("The guard with id:  " + id + " doesn't exist");
