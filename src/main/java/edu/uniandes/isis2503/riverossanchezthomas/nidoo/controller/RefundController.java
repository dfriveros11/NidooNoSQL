...
public class RefundController {
	...
	@ResponseBody
	public Refund getRefundById(@PathVariable("id") String id) {
		try {
	...
	@ResponseBody
	public String deleteRefund(@PathVariable("id") String id) {
		try {
	...
	@GetMapping("/{id}/bill")
	@ResponseBody
	public Bill findBillRefund(@PathVariable("id") String id) {
		try {
			Refund refund = refundDAO.findRefundById(id);
			if (refund == null) {
