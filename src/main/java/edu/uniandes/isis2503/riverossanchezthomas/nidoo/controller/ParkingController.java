...
public class ParkingController {
	...
	@ResponseBody
	public Parking getParking(@PathVariable("id") String id) {
		try {
	...
	@ResponseBody
	public String deleteParking(@PathVariable("id") String id) {
		try {
			if (parkingDao.findParkingById(id) == null) {
				throw new Exception("The Parking with id: " + id + " doesn´t exist in our database");
			}
	...
	@ResponseBody
	public String createParkingParkingSpot(@PathVariable("id") String id, @RequestBody @Valid ParkingSpot parkingspot) {
		try {
			Parking parking = parkingDao.findParkingById(id);
			if (parking == null) {
				throw new Exception("The Parking with id: " + id + " doesn´t exist in our database");
	...
	@ResponseBody
	public ParkingSpot findByIDParkingParkingSpot(@PathVariable("idP") String idP, @PathVariable("idPS") String idPS) {
		try {
	...
	@ResponseBody
	public List<ParkingSpot> findParkingParkingSpots(@PathVariable("idP") String idP) {
		try {
			Parking parking = parkingDao.findParkingById(idP);
			if (parking == null) {
				throw new Exception("The Parking with id: " + idP + " doesn´t exist in our database");
	...
	@ResponseBody
	public ParkingSpot updateParkingParkingSpot(@PathVariable("idP") String idP,
		...
		try {
			...
			if (oldparkingSpot == null) {
				throw new Exception(
						"The Parking spot with id: " + parkingSpot.getId() + " doesn´t exist in our database");
			}
	...
	@ResponseBody
	public String deleteParkingParkingSpot(@PathVariable("idP") String idP, @PathVariable("idPS") String idPS) {
		try {
			Parking parking = parkingDao.findParkingById(idP);
			if (parking == null) {
				throw new Exception("The Parking with id: " + idP + " doesn´t exist in our database");
	...
	@ResponseBody
	public ParkingProvider findParkingParkingprovider(@PathVariable("idP") String idP) {
		try {
			Parking parking = parkingDao.findParkingById(idP);
			if (parking == null) {
				throw new Exception("The Parking with id: " + idP + " doesn´t exist in our database");
	...
	@ResponseBody
	public String createParkingGuard(@PathVariable("id") String id, @RequestBody @Valid Guard guard) {
		try {
			Parking parking = parkingDao.findParkingById(id);
			if (parking == null) {
				throw new Exception("The Parking with id: " + id + " doesn´t exist in our database");
	...
	@ResponseBody
	public Guard findByIDParkingGuard(@PathVariable("idP") String idP, @PathVariable("idG") String idG) {
		try {
			Parking parking = parkingDao.findParkingById(idP);
			if (parking == null) {
				throw new Exception("The Parking with id: " + idP + " doesn´t exist in our database");
			}
			Guard guard = guardDao.findGuardById(idG);
			if (guard == null) {
	...
	@ResponseBody
	public List<Guard> findParkingGuards(@PathVariable("idP") String idP) {
		try {
			Parking parking = parkingDao.findParkingById(idP);
			if (parking == null) {
				throw new Exception("The Parking with id: " + idP + " doesn´t exist in our database");
	...
	@ResponseBody
	public Guard updateParkingGuard(@PathVariable("idP") String idP, @RequestBody @Valid Guard guard) {
		try {
			Parking parking = parkingDao.findParkingById(idP);
			if (parking == null) {
				throw new Exception("The Parking with id: " + idP + " doesn´t exist in our database");
			}
			Guard oldGuard = guardDao.findGuardById(guard.getId());
			if (oldGuard == null) {
	...
	@ResponseBody
	public String deleteParkingGuard(@PathVariable("idP") String idP, @PathVariable("idG") String idG) {
		try {
			Parking parking = parkingDao.findParkingById(idP);
			if (parking == null) {
				throw new Exception("The Parking with id: " + idP + " doesn´t exist in our database");
