...
public class ParkingProviderController {
	...
	/**
	 * /parkingproviders/create -> create a new parkingprovider user and save it in
	 * the database.
	 * 
	 * @return a string describing if the parking provider is succesfully created or
	 *         not.
	 */
	@PostMapping("/create")
	@ResponseBody
	...
	public ParkingProvider updateParkingProvider(@RequestBody @Valid ParkingProvider parkingProvider) {
		try {
			...
			String idParkingProvider = parkingProvider.getId();
	...
	public List<ParkingProvider> getParkingProvider() {
		try {
			List<ParkingProvider> parkingProviders = parkingProviderDAO.findAll();
	...
	/**
	 * /parkingproviders/delete/{id} -> delete the parking provider user having
	 * thepassed id.
	 * 
	...
	@ResponseBody
	public String deleteParkingProvider(@PathVariable("id") String id) {
		try {
	...
	@ResponseBody
	public String createParkingProviderParking(@PathVariable("id") String id, @RequestBody @Valid Parking parking) {
		try {
	...
	@ResponseBody
	public Parking findByIDParkingParkingProvider(@PathVariable("idPV") String idPV, @PathVariable("idP") String idP) {
		try {
			...
			Parking parking = parkingDao.findParkingById(idP);
			if (parking == null) {
	...
	@ResponseBody
	public List<Parking> findParkingParkingprovider(@PathVariable("idP") String idP) {
		try {
	...
	@ResponseBody
	public Parking updateParkingParkingProvider(@PathVariable("idPV") String idPV, @RequestBody @Valid Parking parking) {
		try {
			ParkingProvider parkingProvider = parkingProviderDAO.findParkingProviderById(idPV);
			if (parkingProvider == null) {
				throw new Exception("The Parking provider with id:  " + idPV + " doesn't exist");
			}
			Parking oldParking = parkingDao.findParkingById(parking.getId());
			if (oldParking == null) {
	...
	@ResponseBody
	public String deleteParkingParkingProvider(@PathVariable("idPV") String idPV, @PathVariable("idP") String idP) {
		try {
			ParkingProvider parkingProvider = parkingProviderDAO.findParkingProviderById(idPV);
			if (parkingProvider == null) {
				throw new Exception("The Parking provider with id:  " + idPV + " doesn't exist");
	...
	@ResponseBody
	public String createParkingSpotParkingProvider(@PathVariable("id") String id,
		...
		return "Parking spot with id " + parkingSpot.getId()
				+ " succesfully created linked to Parking provider  with id: " + id;
	}
	...
	@ResponseBody
	public ParkingSpot findByIDParkingSpotParkingProvider(@PathVariable("id") String id, @PathVariable("idP") String idP) {
		try {
			ParkingProvider parkingProvider = parkingProviderDAO.findParkingProviderById(id);
			if (parkingProvider == null) {
				throw new Exception("The Parking provider with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public List<ParkingSpot> findParkingSpotParkingprovider(@PathVariable("id") String id) {
		try {
			ParkingProvider parkingProvider = parkingProviderDAO.findParkingProviderById(id);
			if (parkingProvider == null) {
				throw new Exception("The Parking provider with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public ParkingSpot updateParkingSpotParkingProvider(@PathVariable("id") String id,
			@RequestBody @Valid ParkingSpot parkingSpot) {
		try {
			ParkingProvider parkingProvider = parkingProviderDAO.findParkingProviderById(id);
			if (parkingProvider == null) {
	...
	@ResponseBody
	public String deleteParkingSpotParkingProvider(@PathVariable("id") String id, @PathVariable("idP") String idP) {
		try {
			ParkingProvider parkingProvider = parkingProviderDAO.findParkingProviderById(id);
			if (parkingProvider == null) {
				throw new Exception("The Parking provider with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public String createBookingParkingProvider(@PathVariable("id") String id, @RequestBody @Valid Booking booking) {
		try {
			ParkingProvider parkingProvider = parkingProviderDAO.findParkingProviderById(id);
			if (parkingProvider == null) {
				throw new Exception("The Parking provider with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public Booking findByIDParkingProviderBooking(@PathVariable("id") String id, @PathVariable("idB") String idB) {
		try {
			ParkingProvider parkingProvider = parkingProviderDAO.findParkingProviderById(id);
			if (parkingProvider == null) {
				throw new Exception("The Parking provider with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public List<Booking> findParkingProviderBooking(@PathVariable("id") String id) {
		try {
			ParkingProvider parkingProvider = parkingProviderDAO.findParkingProviderById(id);
			if (parkingProvider == null) {
				throw new Exception("The Parking provider with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public Booking updateParkingProviderBooking(@PathVariable("id") String id, @RequestBody @Valid Booking booking) {
		try {
			ParkingProvider parkingProvider = parkingProviderDAO.findParkingProviderById(id);
			if (parkingProvider == null) {
				throw new Exception("The Parking provider with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public String deleteParkingProviderBooking(@PathVariable("id") String id, @PathVariable("idB") String idB) {
		try {
			ParkingProvider parkingProvider = parkingProviderDAO.findParkingProviderById(id);
			if (parkingProvider == null) {
				throw new Exception("The Parking provider with id:  " + id + " doesn't exist");
