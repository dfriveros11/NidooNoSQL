...
public class VehicleController {
	...
	@ResponseBody
	public Vehicle getVehicleID(@PathVariable("id") String id) {
		try {
	...
	/**
	 * /vehicles/delete/{id} -> delete the vehicles user having the passed id.
	 * 
	 * @param id The id for the vehicles to delete
	...
	@ResponseBody
	public String createBookingVehicle(@PathVariable("id") String id, @RequestBody @Valid Booking booking) {
		try {
			Vehicle vehicle = vehicleDAO.findVehicleById(id);
			if (vehicle == null) {
				throw new Exception("The vehicle with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public Booking findByIDVehicleBooking(@PathVariable("id") String id, @PathVariable("idB") String idB) {
		try {
			Vehicle vehicle = vehicleDAO.findVehicleById(id);
			if (vehicle == null) {
				throw new Exception("The vehicle with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public List<Booking> findVehicleBooking(@PathVariable("id") String id) {
		try {
			Vehicle vehicle = vehicleDAO.findVehicleById(id);
			if (vehicle == null) {
				throw new Exception("The vehicle with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public Booking updateVehicleBooking(@PathVariable("id") String id, @RequestBody @Valid Booking booking) {
		try {
			Vehicle vehicle = vehicleDAO.findVehicleById(id);
			if (vehicle == null) {
				throw new Exception("The vehicle with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public String deleteVehicleBooking(@PathVariable("id") String id, @PathVariable("idB") String idB) {
		try {
			Vehicle vehicle = vehicleDAO.findVehicleById(id);
			if (vehicle == null) {
				throw new Exception("The vehicle with id:  " + id + " doesn't exist");
