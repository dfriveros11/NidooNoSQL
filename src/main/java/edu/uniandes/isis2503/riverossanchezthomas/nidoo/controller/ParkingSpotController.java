...
public class ParkingSpotController {
	...
	/**
	 * /parkingspots/create -> create a new parking spot and save it in the
	 * database.
	 * 
	 * @return a string describing if the parking spot is succesfully created or
	 *         not.
	 */
	@PostMapping("/create")
	@ResponseBody
	 ...
	 * 
	 * @return the information that is updated describing if the parking spot is
	...
	@ResponseBody
	public ParkingSpot getParkingSpot(@PathVariable("id") String id) {
		try {
	...
	/**
	 * /parkingspots/delete/{id} -> delete the parking spot user having thepassed
	 * id.
	 * 
	 * @param id The id for the parking spot to delete
	 * @return A string describing if the parking spot is succesfully deleted or
	 *         not.
	 */
	@DeleteMapping("/delete/{id}")
	@ResponseBody
	public String deleteParkingSpot(@PathVariable("id") String id) {
		try {
	...
	@ResponseBody
	public ParkingProvider findParkingSpotParkingprovider(@PathVariable("id") String id) {
		try {
			ParkingSpot parkingSpot = parkingspotDAO.findParkingSpotById(id);
			if (parkingSpot == null) {
				throw new Exception("The Parking Spot with id: " + id + " doesn´t exist in our database");
	...
	@ResponseBody
	public Parking findParkingSpotsParking(@PathVariable("id") String id) {
		try {
			ParkingSpot parkingSpot = parkingspotDAO.findParkingSpotById(id);
			if (parkingSpot == null) {
				throw new Exception("The Parking Spot with id: " + id + " doesn´t exist in our database");
	...
	@ResponseBody
	public String createBookingParkingSpot(@PathVariable("id") String id, @RequestBody @Valid Booking booking) {
		try {
			ParkingSpot parkingSpot = parkingspotDAO.findParkingSpotById(id);
			if (parkingSpot == null) {
			...
			List<Booking> bookingTest = parkingspotDAO.findParkingSpotWithBookingInDate(date);
			if (bookingTest != null) {
	...
	@ResponseBody
	public Booking findByIDParkingSpotBooking(@PathVariable("id") String id, @PathVariable("idB") String idB) {
		try {
			ParkingSpot parkingSpot = parkingspotDAO.findParkingSpotById(id);
			if (parkingSpot == null) {
				throw new Exception("The Parking spot with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public List<Booking> findParkingSpotBooking(@PathVariable("id") String id) {
		try {
			ParkingSpot parkingSpot = parkingspotDAO.findParkingSpotById(id);
			if (parkingSpot == null) {
				throw new Exception("The Parking spot with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public Booking updateParkingSpotBooking(@PathVariable("id") String id, @RequestBody @Valid Booking booking) {
		try {
			ParkingSpot parkingSpot = parkingspotDAO.findParkingSpotById(id);
			if (parkingSpot == null) {
				throw new Exception("The Parking spot with id:  " + id + " doesn't exist");
	...
	@ResponseBody
	public String deleteParkingSpotBooking(@PathVariable("id") String id, @PathVariable("idB") String idB) {
		try {
			ParkingSpot parkingSpot = parkingspotDAO.findParkingSpotById(id);
			if (parkingSpot == null) {
				throw new Exception("The Parking spot with id:  " + id + " doesn't exist");
